          ...
          >
            <div className="col-lg-7 col-md-12 col-12">
              ...
              <div className="d-flex align-items-center">
                <Link to="/about" className="btn-get-started animate-pulse-glow">
                  Read More
                </Link>
                <ModalVideo channel='youtube' autoplay='true' isOpen={isOpen} videoId="yqWX86uT5jM" onClose={() => setOpen(false)} />
              <span className="btn-watch-video d-flex align-items-center pointer animate-fade-up delay-2" onClick={()=> setOpen(true)}> <i className="bi bi-play-circle-fill"></i>
